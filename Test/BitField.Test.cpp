...
TEST_CASE("Cafe.Core.Misc.BitField", "[Core][Misc][BitField]")
{
	SECTION("BitField")
	{
		...
		REQUIRE(allClearedValue ==
		        0b0001000100100010001100110100010001010101011001100111011110000000);
		...
		REQUIRE(composedValue ==
		        0b0001000100100010001100110100010001010101011001100111011110110000);
